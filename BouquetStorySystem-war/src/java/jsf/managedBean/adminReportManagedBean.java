...
public class adminReportManagedBean {
    ...
    /**
     * Creates a new instance of adminReportManagedBean
     */
    ...
    public void generateReport(ActionEvent event) {
        ...
        try {
            ...
            InputStream reportStream = FacesContext.getCurrentInstance().getExternalContext().getResourceAsStream("/jasperreport/adminreport.jasper");
