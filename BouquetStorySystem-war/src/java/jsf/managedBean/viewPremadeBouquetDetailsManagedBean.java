 ...
 * @author matt_
 */
@Named(value = "viewPremadeBouquetDetailsManagedBean")
@ViewScoped
public class viewPremadeBouquetDetailsManagedBean implements Serializable {
    ...
    /**
     * Creates a new instance of viewPremadeBouquetDetailsManagedBean
     */
    public viewPremadeBouquetDetailsManagedBean() {
    }
