...
public class Decoration implements Serializable {
    ...
    public int hashCode() {
        int hash = 0;
        hash += (decorationId != null ? decorationId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        Decoration other = (Decoration) object;
        if ((this.decorationId == null && other.decorationId != null) || (this.decorationId != null && !this.decorationId.equals(other.decorationId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "entity.Decoration[ id=" + decorationId + " ]";
    }
