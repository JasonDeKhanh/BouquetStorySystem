...
//        try
//        {
//            List<Customer> customerEntities = customerSessionBean.retrieveAllCustomers();
//
//            for(Customer customerEntity:customerEntities)
//            {                
//                 List<SaleTransaction> saleTransactions = customerEntity.getSaleTransactions();
//                 
...
//            }
//            
//            GenericEntity<List<Customer>> genericEntity = new GenericEntity<List<Customer>>(customerEntities) {};
//
